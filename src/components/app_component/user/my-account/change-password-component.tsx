...
const API = {
  ...
  // your existing token session endpoints
...
// Helper to detect device type from browser details
...
function Avatar({
  ...
  return (
    <div className="relative group">
      ...
      >
        {src ? (
          // if src is filename only, you may need prepend base url
    ...
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-8 border border-blue-100">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          <Avatar src={form.login_user_image} name={fullName || "User"} size="lg" />
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <InputGroup label="First Name" required>
                  <Input value={form.login_user_first_name} onChange={(e) => set("login_user_first_name", e.target.value)} readOnly />
                </InputGroup>

                <InputGroup label="Last Name" required>
                  <Input value={form.login_user_last_name} onChange={(e) => set("login_user_last_name", e.target.value)} readOnly />
                </InputGroup>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <InputGroup label="Phone Number" icon={Phone} required>
                  <Input value={form.login_user_mobile} onChange={(e) => set("login_user_mobile", e.target.value)} icon={Phone} readOnly />
                </InputGroup>

                <InputGroup label="Website" icon={Globe}>
                  <Input value={form.website ?? ""} onChange={(e) => set("website", e.target.value)} icon={Globe} readOnly />
                </InputGroup>
              </div>
            </div>
          </div>
...
function PasswordTab() {
  ...
  const canSubmit =
    !!currentPassword && !!newPassword && !!confirmPassword && isMinLen && passwordsMatch && !loading
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          <div className="space-y-5">
            ...
            <InputGroup
              ...
              icon={Lock}
              required
              error={newPassTouched && !isMinLen ? "Minimum 8 characters required" : undefined}
            >
              <Input
                type="password"
                value={newPassword}
          ...
          <div className="pt-4">
            ...
            {!canSubmit && (newPassTouched || confirmTouched) ? (
              <p className="text-xs text-gray-500 mt-2 text-center">
                Please meet all requirements and make sure both passwords match.
              </p>
            ) : null}
          </div>
        </form>
...
/* ---------------------- REDESIGNED: Netflix-style Light Theme Manage Access & Devices Tab ---------------------- */
function ManageDevicesTab() {
  ...
  // Current device (first item) and other devices
  ...
  return (
    <div className="space-y-6">
      {/* Netflix-style header with red accent */}
      ...
      {loading ? (
        ...
        <>
          {/* Current Device - Highlighted with red accent */}
          {currentDevice && (
                  ...
                  >
                    ...
                    <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h5 className="font-medium text-gray-900 mb-1.5">
                            {deviceInfo.type}
                          </h5>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-blue-600/80">
            Regularly review your active devices and sign out from any you don't recognize. 
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <div className="max-w-3xl flex justify-start">
            <div className="flex items-center justify-center border-b border-gray-200 flex-wrap">
              ...
              >
                Personal Info
                {tab === "information" && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 rounded-full" />}
              </button>
              ...
              >
                Password
                {tab === "password" && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 rounded-full" />}
              </button>
              ...
              >
                ...
                {tab === "devices" && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-red-600 rounded-full" />}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="transition-all duration-300">
          {tab === "information" ? <InformationTab /> : tab === "password" ? <PasswordTab /> : <ManageDevicesTab />}
        </div>

        {/* Quick Stats only for info tab */}
        {tab === "information" && (
          <div className="mt-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl p-4 border border-gray-200">
                ...
                <div className="mt-2">
                  <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full w-3/4 bg-gradient-to-r from-blue-500 to-blue-600" />
                  </div>
                  <p className="text-sm font-semibold text-gray-900 mt-2">75%</p>
                </div>
              </div>
              <div className="bg-white rounded-xl p-4 border border-gray-200">
              ...
              <div className="bg-white rounded-xl p-4 border border-gray-200">
                ...
                <p className="text-sm font-semibold text-gray-900 mt-2">2024</p>
              </div>
              <div className="bg-white rounded-xl p-4 border border-gray-200">
                <p className="text-xs text-gray-500">Last Updated</p>
                <p className="text-sm font-semibold text-gray-900 mt-2">Today</p>
              </div>
            </div>
          </div>
        )}
