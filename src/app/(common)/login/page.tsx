...
function LoginForm() {
  ...
  const onLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ 1st priority: original requested page
      if (redirectFromUrl) {
        window.location.replace(redirectFromUrl);
        return;
      }

      // ✅ 2nd priority: existing wheretogo logic
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#f4f6fb] p-2 sm:p-3">
                ...
                <div className="flex flex-1 items-center justify-center">
                  <div className="relative w-full max-w-[330px] xl:max-w-[350px]">
                    ...
                    <div className="absolute -right-3 top-7 rounded-full border-4 border-white bg-white p-1 shadow-lg">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#1f2937] text-[9px] font-bold text-white">
                        24/7
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex h-full items-center justify-center bg-white px-5 py-5 sm:px-7 lg:px-8">
              <div className="w-full max-w-[380px]">
                <div className="mb-5">
                  ...
                  <h1 className="text-center text-[26px] font-bold tracking-tight text-gray-900">
                    Welcome back!
                  </h1>
